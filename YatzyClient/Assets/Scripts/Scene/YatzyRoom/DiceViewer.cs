    ...
    public void SetDice(int diceIndex, int num)
    {
        switch(num)
        {
            case 1:
                ...
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(-90f, 0f, 0f);
                break;
            case 2:
                diceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
                break;
            case 3:
                diceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, -90f);
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, -90f);
                break;
            case 4:
                diceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, 90f);
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, 90f);
            ...
            case 5:
                ...
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(0f, 0f, 180f);
                break;
            case 6:
                diceList[diceIndex].transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
                lockedDiceList[diceIndex].transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
